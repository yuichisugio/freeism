...
5. **SNS を見ると比較癖で不幸になるので、インフルエンサーたちは評価軸ポイントが与えられなくなるかも**
6. 不幸にならない人にしか見せられない仕組みで対応するしかない。その仕組みがない SNS を利用すれば KOL はマイナス評価で報酬が得られない
...
7. **幸福度向上のジレンマ**
8. 人間は幸福になろうと目指すことで逆に不幸になる性質があるから、評価軸で幸福度の向上をかけたら、みんなが幸福になろうとすることで、逆に不幸になってしまうのではないか
9. **生産性や科学技術の進歩の向上が止まるかも**
10. 幸福度の向上を評価軸に入れたら、経済成長が必ずしも幸福度の向上をもたらすわけでは無いから、技術革新の発生や生産性の向上が無くなってしまうかもしれない
11. **評価軸の決定時の懸念点**
12. 評価軸を直接民主主義で決める場合は、間違った指標で測定することに決定してしまえば、間違ったインセンティブ設計になってしまう
    1. すぐに他の評価軸の仕組みに移動できるようにしたり、馬鹿な意思決定を選ぶことがなくなるような仕組みが必要
13. 貧困の測り方、幸福度の向上の測り方、その他のいろいろな評価軸を測るときの指標の計算方法はいくらでもある
14. **測定が難しい人の幸福度をどのようにして測ればよい？**
15. 赤ちゃん、子供、死人などの幸福度の測定はどうすれば良いか
16. それによって、暴力をしたり、教育的に良い行いをした場合の対処の方法を提供したい
17. **評価軸に貢献しないけど欲求的に求めてしまうサービス**
...
23. **倒産することがないので、効率性を高めるインセンティブが少なくなる**
...
44. **嫌いなグループにノウハウ共有するとマイナス評価になり、ノウハウ共有のインセンティブがなくなる問題**
...
48. **供給量は価格ではなく貢献度で評価される**
49. 資本主義では価格を見て供給側が供給量を考えていたのを、無料主義では供給側はどれだけ評価軸に貢献できるかどうかを見て供給量を考える社会になる
    1. 貢献度合いを予測市場で予測して、その予測に従って供給するようになるのかもしれない
50. 全く貢献度合いを予測できずに、供給管理がめちゃくちゃになり悲惨な社会になるか
51. **オークションにするだけで嫌悪感を感じる人がいる**
    1. 予約困難店の席のオークションサイトやアニメのグッズをオークションにするだけで嫌われることが多いけど仕組みとして強制的にオークションにするので、そんな嫌われるような問題がなくなるようにする
52. **ゼロ価格効果で消費を喚起させることによるデメリット**
...
58. **評価軸への貢献による報酬としての評価軸ポイント発行で交換比率で不利になる問題**
...
- 問題点
  - 商材ごとに SNS アカウントがあるわけでは無い
  - その場合では、その商材関連の SNS や何かしらの ID 指定でポイント付与する
  - それ関連の商材や様々な ID 指定になるため、アカウントで外部連携を様々なサービスで行う必要がある問題点がある
...
- **オークションの「載せどころ」**
  - 取引機能をハブ・アプリ側に長く集約し続けるか、外部サービスとの API 連携へ寄せるかは製品世代ごとに再検討の余地がある。無料主義のアルゴリズム（シングルプライス等）と異なり、アプリ単体の構成はプラットフォーム戦略であり本質経済モデルとは切り離して判断しうる

- **既存マーケットプレイスと評価軸ポイント**
  - 法定通貨中心の大手 EC／オークション等で評価軸ポイントを消費し、残余をアプリ側で検証する、といった外部決済との接続を目指す場合、**読み取り専用の公開情報**とは別に、**残高変動や落札結果を自動で反映する書き込み系API**の設計や権限制御が必要になる（実装フェーズでの検討事項）
