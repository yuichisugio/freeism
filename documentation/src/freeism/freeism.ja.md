...
3. **非干渉の権利により多様性がなくなり、イノベーションが起こらない懸念**
...
9.  **SNS を見ると比較癖で不幸になるので、インフルエンサーたちは評価軸ポイントが与えられなくなるかも**
   1. 不幸にならない人にしか見せられない仕組みで対応するしかない。その仕組みがない SNS を利用すれば KOL はマイナス評価で報酬が得られない
...
10. **幸福度向上のジレンマ**
   1. 人間は幸福になろうと目指すことで逆に不幸になる性質があるから、評価軸で幸福度の向上をかけたら、みんなが幸福になろうとすることで、逆に不幸になってしまうのではないか
11. **生産性や科学技術の進歩の向上が止まるかも**
   1. 幸福度の向上を評価軸に入れたら、経済成長が必ずしも幸福度の向上をもたらすわけでは無いから、技術革新の発生や生産性の向上が無くなってしまうかもしれない
12. **評価軸の決定時の懸念点**
   1. 評価軸を直接民主主義で決める場合は、間違った指標で測定することに決定してしまえば、間違ったインセンティブ設計になってしまう
      1. すぐに他の評価軸の仕組みに移動できるようにしたり、馬鹿な意思決定を選ぶことがなくなるような仕組みが必要
   2. 貧困の測り方、幸福度の向上の測り方、その他のいろいろな評価軸を測るときの指標の計算方法はいくらでもある
13. **測定が難しい人の幸福度をどのようにして測ればよい？**
   1. 赤ちゃん、子供、死人などの幸福度の測定はどうすれば良いか
   2. それによって、暴力をしたり、教育的に良い行いをした場合の対処の方法を提供したい
14. **評価軸に貢献しないけど欲求的に求めてしまうサービス**
...
20. **倒産することがないので、効率性を高めるインセンティブが少なくなる**
...
40. **ピアツーピアな取引ではない懸念**
    1. 貨幣はピアツーピアで取引できるが、無料主義では無料主義アプリを通して行う必要があるので、中央集権的になる
41. **嫌いなグループにノウハウ共有するとマイナス評価になり、ノウハウ共有のインセンティブがなくなる問題**
...
45. **供給量は価格ではなく貢献度で評価される**
   1. 資本主義では価格を見て供給側が供給量を考えていたのを、無料主義では供給側はどれだけ評価軸に貢献できるかどうかを見て供給量を考える社会になる
      1. 貢献度合いを予測市場で予測して、その予測に従って供給するようになるのかもしれない
   2. 全く貢献度合いを予測できずに、供給管理がめちゃくちゃになり悲惨な社会になるか
46. **オークションにするだけで嫌悪感を感じる人がいる**
    1.  予約困難店の席のオークションサイトやアニメのグッズをオークションにするだけで嫌われることが多いけど仕組みとして強制的にオークションにするので、そんな嫌われるような問題がなくなるようにする
47. **ゼロ価格効果で消費を喚起させることによるデメリット**
...
53. **評価軸への貢献による報酬としての評価軸ポイント発行で交換比率で不利になる問題**
