...
5. 「どれだけ差別化・独占できるか」から「どれだけ共有・協力できるか」を競争する社会になる
...
8. 新しい相関関係・より正確な貢献度・価値のある行動を発見できる
...
14. 人事評価で成果主義を採用すると、個々人がノウハウを共有しようとしないデメリットを解決できる
...
19. 今まではお金が介在しない部分でも対価が得られるようになる
...
20. 「正の外部性に対価」「負の外部性に費用」を与える（外部性の内部化）
...
21. アイデアを出すだけでも評価されるようになる
    - 貢献検知の仕組みにより実現する

22. 失敗しても対価を与えることができる
...
30. モラルハザードや逆選択の問題が少なくなる
    - 情報がオープンになることで、モラルハザードや逆選択の問題が少なくなる

31. オープンソースの代替品が現れるまでの時間を短縮される
...
1. 値段が安くなる
   - 下記の仕組みを利用します
     1. 公開＆共有する社会になる
     2. 干渉されない社会になる（非干渉の権利）
     3. 合理的な意思決定がされやすくなる
     4. 参考にされただけで報酬が得られる（貢献検知の仕組み）
     5. 行政・国間の競争促進
     6. 無料主義の仕組みを活かせる
     7. 税金が不要で、税金のメリットを活かせる
     8. 評価軸の仕組み
     9. 相互運用性が高まる仕組み
   - 下記により実現させます
...
2. 納得できない法律が減る
    - 下記により実現させます
      ...
      - 「汎用的な法律を作る」により、自分が良いと考える評価軸に沿ってルールが作られることにより、納得できない法律が少なくなる
...
25. 対価を求めるだけで SDGs の目標を達成できる仕組みを作れる
...
32. 無料主義では、競争がなくても改善するインセンティブを作れる
    - 他人と競争せずとも、評価軸に貢献しないと報酬が得られないから、常に今よりも評価軸に貢献するように改善するインセンティブが作れる

33. 無料主義になれば、無意識に顔が良い人を選んでしまうようなことでも罰を受けたり報酬が下がる社会になる
    - データ分析で判断されるから
...
42. 無料主義でも、供給側が価格決定を行うことは可能だけど「ダンピング」や「ボッタクリ」も可能だけど行うメリットがない
...
56. 長期的な投資を行うための目の前のキャッシュエンジンを作る必要性が少なくなる
...
59. 公益になること（評価軸への貢献）をしたら、報酬がもらえる
...
80. 税金がなくなることで節税に時間をかける必要がなくなる
    - 節税が不要になり、節税にかける労力を科学技術の進歩に使えるようにしたい

81. 早く終わった分だけ追加のタスクが与えられる問題
...
85. 既存の供給者が新規参入の供給者を増やすインセンティブができる
...
89. 無料主義では、自動的に効果的利他主義になるインセンティブを作れる
...
110. 営利企業のサービスが公共財的な機能を持っている場合にも二律背反にならず対応可能
...
111. 無料主義では、需要側の給料が変わらなくても、同じままでも、供給側の提供する商品の価格は下がっていく
...
1. 干渉されない社会になる
    - 「非干渉の仕組み」の仕組みにより、関わりたくない人と関わる必要がなくなる社会を実現する
...
4. 特定の既得権益の意見を重視した政治が行われにくくなり、生活の質が高まります
...
6. 「他人が何をしようが関係ないが、自分には干渉しないで欲しい」の考えを今よりは実現できる
   - 高齢者がどんな運転をしようが勝手だが、高齢者が自分の生活圏内では運転しないで欲しい

7. 左翼や極端な思想の人や対立している思想の人とも関わる必要はなくなる
