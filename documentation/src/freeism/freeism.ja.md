...
3. 税金が不要で、税金のメリットを活かせる
   - 説明
     - 税金のようにコミュニティから取り上げて分配する行為は、「評価軸の仕組み」で評価軸がポイントを発行すれば良いだけなので税金として取り上げる必要はない。
   ...
   - 税金の役割には、「制限させる役割」と「税収を獲得する役割」と「格差是正」がある
     1. 格差是正
     1. 「枠の仕組み」で、使用できるポイント数を調整することで格差是正
     1. 評価軸に貢献するために、独占せず全員に供給するインセンティブにより、格差が大きくても分配せずに全員が得られる社会になる
     1. 情報共有を積極的に行うインセンティブなどの仕組みにより、格差が大きくても、そもそもの物価が安く低予算で生活水準の高い生活ができるようになります
     1. 税収を獲得する役割
...
6. 無料主義では、付加価値をつけず販売＆人件費することにより、低コストで得られるようになる
...
14. 詐欺の被害を軽減できる
    ...
    - さらに評価軸に貢献しない報酬がないため、スパムメール、ネズミ講、 ネットワークビジネス、評価軸に貢献しない怪しく科学的に全く効果のない治療方法、などを行ったとしても評価軸に貢献しないから報酬が得られず意味がない
