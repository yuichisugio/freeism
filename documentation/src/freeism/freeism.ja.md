...
4. **（評価者）自身が決めた評価する軸を基に、供給者を評価する**
   - 評価軸が「町の発展」の場合は、町へ貢献する作業ごとに 1 ポイント付与する方法など、何でもよい
5. **（評価者）評価結果をもとに、供給者に評価軸ごとのポイントを付与する**
   - 供給者の A 作業が、B,C の評価軸から評価された場合は、B,C のポイントをそれぞれ受け取る
   - 供給者は、1 つの労働で複数の評価軸から評価されることも可能だし、複数の評価軸のポイントを受け取ることも可能
