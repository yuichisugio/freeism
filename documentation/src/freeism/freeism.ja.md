...
4. **評価軸の決定時の懸念点**
5. 評価軸を直接民主主義で決める場合は、間違った指標で測定することに決定してしまえば、間違ったインセンティブ設計になってしまう
   1. すぐに他の評価軸の仕組みに移動できるようにしたり、馬鹿な意思決定を選ぶことがなくなるような仕組みが必要
6. 貧困の測り方、幸福度の向上の測り方、その他のいろいろな評価軸を測るときの指標の計算方法はいくらでもある
7. **測定が難しい人の幸福度をどのようにして測ればよい？**
   1. 赤ちゃん、子供、死人などの幸福度の測定はどうすれば良いか
   2. それによって、暴力をしたり、教育的に良い行いをした場合の対処の方法を提供したい

8. **評価軸に貢献しないけど欲求的に求めてしまうサービス**
...
14. **倒産することがないので、効率性を高めるインセンティブが少なくなる**
...
35. **嫌いなグループにノウハウ共有するとマイナス評価になり、ノウハウ共有のインセンティブがなくなる問題**
...
47. **評価軸への貢献による報酬としての評価軸ポイント発行で交換比率で不利になる問題**
