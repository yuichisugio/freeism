...
- [無料主義 v3 beta](#無料主義-v3-beta)
  ...
  - [実現したいこと](#実現したいこと-1)
    ...
    - [小目標](#小目標)
      ...
      - [研究の支援](#研究の支援)
      - [評価軸の仕組み関連](#評価軸の仕組み関連-1)
      - [Idea 関連](#idea-関連-1)
      - [許可を不要にしたい](#許可を不要にしたい-1)
      - [非干渉の権利で実現したいこと](#非干渉の権利で実現したいこと-1)
      - [汎用的な法律](#汎用的な法律)
...
- **価格を激減させたい**
  - この世に存在する商材を獲得するのに必要な労働時間を、最低でも 10 分の 1、理想は 100 分の 1 以下にしたい

- **生産性向上の目標**
  - 毎年、商材の獲得に必要な労働時間が10％減るようにしたい
