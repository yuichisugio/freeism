...
3. **税金が不要で、税金のメリットを活かせる**
   ...
   - 税金の役割には、「制限させる役割」と「税収を獲得する役割」と「格差是正」がある
     ...
     6. **制限させる役割**
        ...
        - 例）誹謗中傷、嫉妬させるコンテンツ
          - Instagram などでのブランド品着用の写真は、閲覧者の比較で幸福度を下げるなら、幸福度向上の評価軸では成果にカウントしない
     7. **物価が安くなる循環ができる**
...
62. **無料主義でレモン市場を少し解決**
    - 評価軸に貢献するために情報を隠さずオープンにし、情報の非対称性を薄める
...
64. **無料主義は掲げた目標の最適化主義になる**
    ...
    - 無料主義では、民主性・健康・倫理・公平・プライバシー・個人尊重など、掲げた評価軸の達成へ向けた最適化へ振りやすい
...
6. **時代が進むごとに思想が多様化する流れに対応できる**
   - 人間のクローン、汎用 AI、デザイナーベイビー、生活費低下で労働が不要に近い社会、極端なリベラル層など、意見の分かれが大きくなる論点が増える
   - 「非干渉の仕組み」で事前に住み分けし、衝突を抑えやすい

7. **多様性が生まれる**
   - 他者の意見へ干渉しにくくなるほど、多様な主張が並びやすい
   - 価値観や居住地で住み分けが進み、争いは減り意思決定は速くなりやすい
...
- ただ単に無料主義の方が同じ商品やサービスを得るために必要な労働時間が少なくなったとしても、資本主義先進国では整備されている社会保障やセーフティーネットなどがあるため、安易に移動せず、副業感覚で移行する人が増えやすい
