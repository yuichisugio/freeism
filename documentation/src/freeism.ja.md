...
1. 解約ボタンが 1 番目立つところにあり、ボタン 1 つで解約できる
1. **マーケティングの評価軸**
...
- **消費喚起**
  ...
  - なので、現在の使用する分だけすべて評価軸ポイントの評価軸ポイントを使用して限定品を使用できる。 <br> それによって、現在は将来のために貯蓄をするけど、無料主義ではいくら使用したとしても評価軸ポイントは戻ってくるので、わざわざ現在の消費を抑える必要がなくなる
