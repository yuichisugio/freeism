...
- 啓発だけに頼っても根絶は難しいため、人種を推測しづらい表示へ寄せる工夫も検討します
...
- その負担を下げるため AI 生成へ逃がす案も用意します
  - 閲覧が続くという事実が負担なら、誰も見ていないという表示へ加工して差し上げます
...
- オーファンテクノロジー（ニッチ領域で利益が薄く、手付かずになりやすい技術）を、無料主義では支援したいです
...
- 最優先の評価軸が達するまで罰を与える設計を想定します
- 評価軸が犯罪率低減なら、もっとも犯罪率を下げる罰を機械選択します
- 幸福度向上を最上位評価軸とする場合、加害者を徹底的に棄損することが全体幸福を伸ばすのか、という棘のある問いが残ります
...
- 一部の評価軸の仕組みでは、刑務所は不要になる
  - 現行区画から退去するだけでは足りません
  - 追放によって他区画の評価軸へ外部性を浴びせる場合は、互換ルールで不利を返す設計を要ります
  - 幸福度向上を掲げる区画が、低幸福度層を量産的に押し出す歪みへ歯止めを掛けます
...
- 「周りに悪影響を与えない限りは自由であるべき」
  - ただし古典的人権観では、被害が見えにくいうちに自由だけが削られる事例も残ります
- 人権侵害は無条件で悪いのではなく、人権侵害をされることによって、被害者の幸福度や、その被害者の人生の目的の達成を妨げるのが悪いだけ
  - 被害へ悪影響が無いなら、観念上の人権侵害ラベルは重く扱いません

- **悪意があるかどうかは関係がない社会**

- 無料主義では、評価軸へ悪い影響だけを見ており、悪意の有無は基本同列です
  - 被害者の幸福度減少が故意で変わるなら、無故意側は罰を軽くします
  - それ以外は故意と同格へ寄せます
...
- 無料主義の投票では、民主主義で行う場合でも、政治家らが掲げる手段ではなく「あるべき姿」という目的へ投票し、評価軸を定義します
- その評価軸達成へ貢献した人に報酬を払います

- **無料主義が次に目指すのは、人間の意思決定の介入を片っ端から減らすこと**

- その商品やサービスを使うかどうかも、丸ごと自力判断せずデータへ寄せたい場合があります
  - 個人の評価軸へ良い影響が大きい選択肢を複数提示し、差が小さい候補から選ばせます
  - すべて自分で選んだ感覚が得られる UI を重ねます

- **獲得できる評価軸ポイント額の予測できる仕組み**

- 無料主義アプリ上で、行動ごとの評価軸ポイントを事前に概算できる UI を載せ、計画へ反映しやすくします
...
- 無料主義では、評価軸コミュニティの意思決定が外へ与える幸福度への影響も拾い、条件次第で域外へ投票権を広げます
  - 米国などの大統領選は全球へ波及するのに、居住国外の市民へ票を渡せない矛盾があります
...
- プロジェクトごとに目標を定め、もっとも近づけられる能力を選考指標へ載せます
...
- 思想が政治を直接動かせない仕組みにします
- 思想ごとに評価軸の仕組みを分け、思想議論を各コミュニティの核へ閉じ込めます
- 同思想が集まるため、反対思想の妨害が意思決定を止めにくくなります
- 設定した思想を最大化するだけで報酬が載る前提へ寄せます
- 政治では思想への配慮と全体利益を同時に満たす合掌を求めず、評価軸最大化へ一本化します
- 報酬も評価軸最大化へ直結させ、思想の実現と数値目標を同一視します
...
- **宗教にはまっていること自体、悪いことではない**

- 他人へ加害しない限り、信拠の仕方は自由です
- 強制改宗や洗脳解除を一律に求めず、幸福度が保たれるなら現状維持も選べます
...
- 抜け道を使っても評価軸へ悪影響なら裁かれます
- 制定済みの不法行為でも提訴が無いだけで免賠が続く穴を塞ぎます
- 犯人特定が曖昧なときは刑事手続が止まりやすい領域へ、評価関数を載せます
- 実害はあるのに立法が遅れた空白を、評価軸側の暫定ルールで埋めます
- これらの抜け道に置かれた悪影響行為は、被害の申立が無くても自動裁量へ載せます
...
- 汎用フレームで悪影響が読めないサービスは、実装までを先に公開します
- 顧客接点だけ別スキルへ分け、貢献検知で開発者と配布者へ分割報酬を載せます
- リスク選好の高い人が公開責任を引き受け、慎重な人は実装に専念できます
- 公開後の悪影響は参照関係だけを裁き、開発者を巻き添えにしない設計も載せます
- こうして開発と実験と流通のスキルを分解し、複合スキル必須の壁を下げます
...
- 事前に NG と示されないまま叱責されると、何を避けるべきか分からず行動が固まります
- 違法性が示されないまま事後マイナスだけが来ると、誰も実験的な行動を取れません
- 週次などで更新する評価軸法律を事前公開し、現在行動へ素直に適用します
- これから行う行動の悪影響度を、説明付きで概算できる UI を載せます
...
- 影響力と責任を一体化させる説明は、フォロワー行動や遺伝・環境要因まで含めて泥濘みやすいです
  - 目立つ当事者へ責任が集中しがちですが、全因果を特定して個人に押し付けるのは不可能に近いです
  - 「責任は観測された最終行為者だけにある」とは限らない、という前提を共有します
- 失敗後に誰が引責するかより、再発最小化へ報酬と罰を載せます
  - 罰が不要なら誰も削られない、という静かな解も許容します
  - 共感できる共同体だけで試し、設計は反復します
- 再発防止へ向けたペナルティと、出来心の烙印押しを混同しないことも明文化します

- **責任の所在を遡る**

- 思想によって、どこまで責任を遡るかどうかを、評価軸の仕組みごとに、パラメータで調節できるようにしたい
  - 例えば、ナイフ製作者も罪に問う評価軸の仕組みを置いたり、目撃し得たのに止めなかった者を同列に扱う区画も設計できます
...
- 無料主義の罰の内容は、今後の犯罪率を下げつつ、加害者個人の評価軸への悪影響を最小化する方針です
- 罰はシステムが自動算出し、「第三者の暴力装置の仕組み」で、サービス運営者や周囲が装置となって他者が執行します
  - 罰の中身も、加害者個人の評価軸への悪影響を抑えながら、将来の犯罪率を小さくする方向で設計します
  - 執行は第三者が担い、無料主義アプリが罰を確定し、加害者の利用サービス運営者や周囲が手続きを進めます

- **複数の評価軸があって、 その評価軸 同士が矛盾している場合**

- 無料主義では、行為を各評価軸で個別に見ると矛盾しても、評価を合算して裁定します
- 各評価軸には重み付けを載せ、合算がマイナスなら罰へ繋げます。ルール同士が食い違っても運用できます
- 従来の個別法域で人間が解釈して罰を決める手間を減らせます
- 合算でマイナスなら罰という単純化が進みます。思想の優先度は数値単位を揃え、単位に重みを掛けたポイントの合計を貢献度とみなします
- 思想の比重は重み付けで表し、矛盾は合算思考で処理します

- **国家以外の第三者による警察機能**

- 国民全員が警察機能を持ち、誰でも加害者へ罰を科せる枠組みを目指します
- 執行許可は無料主義アプリと評価軸の仕組みが出し、私刑とは切り分けます
- 全体利益へ資すれば評価されるなら、国が警察や軍の暴力装置を抱えず民間へ委ねられます
- 利益が出なければ報酬も薄く、腐敗も抑えられます
- 国が装置を直接持つ必然は下がり、立ち上げコストも抑えられます

- **連続的で、所属はレイヤーで分かれる(一部が重なる多層性)の社会**

- 国民性の二値ラベルだけに頼らず、移動とコミュニティ乗り換えを容易にします
- 完全なフラット化で多様性が潰れる均衡も避けます
- あらゆるパラメーターが連続的になり、中間が許容される万人マイノリティ社会を目指します
  - ルールについて賛否を細かく表明し、自分向けのセットを組み立てつつ他者へ強要しない設計です
  - 一部の行為だけ罪化し、同種の別行為は非罪のままにしたい要望も、個人設定と非干渉で実現しやすくします
  - 部分的な規制は特定の評価軸コミュニティへの加入で担い、完全形は仮想居住が前提になる、という整理です
  - 複数コミュニティへの同時所属と、レイヤー単位の切り替えも許容します
...
- エビデンス主義の Wikipedia は、根拠なし投稿を落としつつ専門家以外も巻き込む集合知モデルです
- 非干渉型 Wikipedia は、証拠請求が発動したら感情混じりの編集を相手側が切れる仕組みで、中立運用の実験場にします

- **フェイクニュースが無くすために無料主義を活用する**

- フェイクでも閲覧数だけでは対価を出さず、評価軸貢献へ紐づけます
- フェイク追随で誤発信したら評価軸ポイントを抑え、警告後も非表示にしない層は剥奪へ回します
- 無料主義アプリが中立的報道窓を抱え、ドネーション依存を下げます
...
- （1）失敗時は「発生率最小化と個人評価軸悪影響最小」を同時に満たす罰へ寄せ、名目上の責任狩りを減らします
- 改善前提の罰が先に見えるなら、信頼はそこから積み上がります
- （2）ミス時にアプリから OO ポイントを被害者へ送る保険も並べます
- （3）ミス対象が失うインセンティブを先に定義します
- （4）自由意志を仮定しません
...
- AI 実行の是非は学習ループへ閉じ、人間への連帯責任は極小化します
- ミス検知後はモデル改善を義務化し、ヒューマンは別ルートで保護します
- 学習器にも「問題最小化罰」を埋め込み、再発予測へ直結させます
- 「責任ゼロ」はミス免罪ではなく、処罰対象をモデルと運用ログへ寄せる読み替えです
- 改善可能な機械に人間を巻き込む罰は、原則セットしません
- プラットフォーム運営者個人を晒す前に、改善保証と被害補填を先に要求する社会像です

- **この世界を構成するのは、一人の人間では、何もできないことばかり。市場のプライステイカーと同じ。**

- その人は運命を受け入れる以外になく、気質まで遺伝子と環境でほぼ定まります。遺伝子の出所は親の恣意ではなく乱数に近く、環境も親が形作った空間へ強く引きずられます。突然変異の契機として宇宙線の飛来が挙げられる場面もあります
- 目前の不祥事は当人に一切の自由度がなかったとは言い切れませんが、その行為は運命線上の帰結として捉えられます。この前提で責任ゼロ社会へ近似します
- 真の原因を掘れば掘るほど、現状の科学では尽きません。鎖全体を説明できる地点はなく、単一の加害者へ責任を固定できません
- 原因連鎖の末端はたいてい人間単体には還元できず、複合要因の帰結として整理できます。だから責任転嫁の儀礼は排し、再発最小化やケアへ資源を回します
- 罰は再発最小化の手段として設計し、道義的報復の本体には据えません
- 被害感情の鎮静が副次効果として乗る場合はありますが、主目的は予測モデル上の改善です
- したがって「責任を取る」儀礼を必須とはしません
- 謝罪を迫る文化は、因果が多因である前提と衝突しがちです
- 複雑な因果から目を背け、単一の責任者へ擬人化する認知バイアスを、計算補助で薄めます
- 行動を遺伝子と環境の帰結として見れば、自由意志のみを前提にした非難は過剰になります
- 単純な責任割当が紛争動員へ再利用される回路を弱め、並列な要因理解へ移行します
...
- **反論しても問題が起こる or 被害を受ける。ようなことがなくなる社会を作りたい**
  - 上司へは反論が減点、追随が加点になりがちで、親や教師でも同調圧と暴力が報酬関数に混入します
  - 反論内容が正しいかどうかを、システムが判断できるようにして、その内容の実行を強制させ、それは変えられないようにしたい
  - それによって、反論による問題発生がなくなるようにしたい

- **助けを求める必要がない仕組み**
  - 「まだ頑張れる」と抱え込む層と、「助けて」と言えない層が同時に存在します
  - 人が口を割る前に、評価軸上で精神指標が閾値を割ったら自動支援へ橋を架けます
...
- 非干渉の権利
  - **ヘイトを止めたい評価軸の仕組みでは、人手を要して工数は重いものの、誤情報の混入を抑える仕組みを用意したいです**
  - 誤情報ゼロへ近づくほど報酬が厚く、人的モニタの工数もペイする設計を評価軸へ載せます
...
- **複雑さ&多様性に対応できるシンプルな仕組みのみで汎用性を作る**
  ...
  - 利害関係・趣味思考・価値観の多様性は「評価軸コミュニティ」と非干渉 UI の組み合わせで受け止めます

- **評価軸ポイントが減る自分の発信を、文法確認みたいに自動で加工してくれるようにしたい**

- 価値観コミュニティへ分かれると同類が集まり、身内基準の同調圧が下がります
- 細部の言い回しまで AI が丁寧語へ整え、火種を先に消す補助を置けます
...
- 競合プロジェクトへフォークし、評価軸ポイントが閾値に達すれば電波塔など共有資産の利用権を付与し、実物の門番を崩します

- **需要と供給の弾力性を高めたい**

- 需要と供給の双方の弾力性を上げ、価格ショックを吸収しやすくします
- 代替ルートが常に並走し、単一ソース依存を許しません
...
- 貸経由で入ったテナントの評価軸ポイントの一部が家賃へ上乗せされ、物件の質が現金以外でも価格付けされます
- 魅力度を上げるほど高貢献テナントが申し込み、土地メンテのインセンティブも乗ります
- 従来型の「みんなが欲しいから値上がり」の単線ではなくなります
- 無料主義側では単純需給の熱だけが給付を増やさず、貸出と幸福度ログが報酬を決めます
- 代替性が低い物件ほどロックイン苦痛が読みやすく、報酬関数へ素直に入ります
- インテリア改善も評価軸へ直結させやすくなります

- **「不完全義務(倫理的に正しいが、法的な義務とまではいえないものを)」がなくなる社会**

- 倫理で望む行為はコミュニティ内で法文化し、グレーゾーンだけを残しません
- 倫理水準の強さは評価軸コミュニティごとにスライドさせます

- **無料主義では、新しい罰の種類が追加される？**

- 再発予測へ効く手段なら、アクセス停止から行動義務付けまで広いメニューになり得ます
- 施設収容に限らず、SNS ブランクや治療義務なども候補になります
- 2 つの最小化（将来被害と個人評価軸ダメージ）の交点で量を決め、自由意志仮定も外します

- **争いを起こしたくなければ、相手属性を曖昧にする**

- 人種ラベルが見えなければ特定層への決めつけが撃ちにくくなります
- 結託して笑いたい場面でも、相手が標的と同じ側か判然としないなら失言を控えます
- 思想プロフィールも同様に伏せ、火種を先に乾燥させません
...
- 会社が人を雇う場合、強制配置なら評価軸ポイントを使います
- 募集応募だけの採用では使いません（指名販売と同様）
- 供給側が販売相手を決めるなら、購入側の評価軸ポイントを預けなくて構いません

- **他国に移住するハードルを下げる**

- 今は母国のルールが合わず移住したくても、国外定住のハードルが高すぎます
  - 評価軸ごとに地域を分け、住む場所を選べるようにします
  - 地域ルールは各自治で運用し、国内引っ越し感覚で住み替えやすくします
  - 好みのルールに合う地域へ移りやすくします
- 規制を選べるようにしたい
- 安全に国外移住ができるようにする
  - アプリの総則として、評価軸グループからの離脱や他グループへの移動を禁じる規定は設けません
  - 有事でも他軸へ移りやすいよう、各評価軸の制度を整えます
  - 宗教への傾倒からも離脱しやすくし、親やコミュニティからの離脱を禁じる慣行を減らします

- **参考にしているコンテンツを見つけるインセンティブを作る仕組みを作りたい**

- （1）制作者が「参考権」を売り、購入者のみ参考・引用可にするモデルがあります
- （2）購入者が改作したコンテンツを広げれば、原作の権利価値が変動します
- （3）人気が増すほど需要が伸び、早期購入者には資産的な含み益も載ります
- （4）初期支援のインセンティブになり、質の良い投稿や記事を見つけやすくなります
  - この枠組みは貢献検知へ転用できるか検討します
  - 未購入で無意識に寄せたケースは検知が難しく、確認コストを請求する案もあります
  - 請求回避のために自主申告や類似検知後の自動申告機能を載せられます
- 早押し参加者への報酬だけを避け、早期参加でも成果なら対価が薄くなる設計で bot を抑えます

- **子育てを支援する評価軸の仕組み特有の仕組み**

- 理解が得られる人から小さなコミュニティを立ち上げ、早期実装へ寄せたいです
  - 一家庭だけで子を育てるリスクは大きいので、例えば 100 組程度の共同保育コミュニティを想定します
  - 平均回帰で失敗リスクが下がり、協力育児の密度も上がります
  - 報酬は子ども個人の稼ぎではなく、コミュニティ内の子ども報酬の中央値の一部を親へ配分する案です
  - 親を選べないリスクを下げるため、日常の養育はコミュニティ主体に寄せます
  - 無料主義では、出生と愛着は親が担い、授業体験は社会側で整えます
  - 親選択の不利益を少しでも薄めたい意図です

- **資金調達が不要な社会に近づける**

- 挑戦のたびに過去の成功者へ金を集める必要は薄めたいです
  - 挑戦者へ、所有権を伴わない評価軸ポイントをシステムが無条件で付与し、挑戦人口を増やします
- エンジェル投資や売却益の再投資ループに依存せず、スタートアップ資金調達の儀式を減らします
  - アドバイス人材は別途必要ですが、ゼロイチの現金調達負荷は下がります
- 起業家へ一律ポイント配布を検討し、配分後の実績が乏しければ通常報酬係数を例えば 0.9 へ下げます
- 挑戦により一定水準まで稼がない場合は通常報酬も減るため、様子見より挑戦側へ傾きます
- 失敗に終わっても評価軸への小さな貢献なら特例ポイントの私的目的利用は認めません
- 特例の私的利用チャネルを狭めインフレ圧を抑えます

- **価格上昇**

- 需要が急増しても値上げは醜いという空気があります
  - 需要追随の値上げにも合理性がある一方で、ブランド毀損への恐れから自制が強く残ります
  - 非効率を助長する説明だけを繰り返す行為はマイナス評価候補にできます
- 無料主義では貢献度モデルへ基づき社員報酬が自動で伸び縮みします
- 上司裁量による不公平感も薄く、経済合理性の判断を優先しやすくします
  - 人間の恣意で効率的な運営判断が歪む余地を狭めます

- **報酬を決める三つの指標**

- 代替性
  - 車輪の再発明を抑えるため代替性が高いほど報酬を抑えます
  - 再発明へ走れば報酬は下がります
- サービスを成立させるパーツ貢献度 →「必要不可欠性の仕組み」
  - 直接は周囲へ届かなくても、下流サービス経由で顧客価値へ繋がります
- 評価軸への貢献度
  - 自社サービスがクライアント評価軸のゴール達成へ寄与できたことを示します
- 上記 3 指標で常時モニターし報酬関数へ載せます
  - 「パーツ貢献度」は自社資産が他サービス収益へ寄与した際のテイクレート OO％で決めます
    - 指標が 1 なら 100％、0 以下なら 0％です
- 供給のたびに 3 指標を計測します
  - ToC でもパーツ貢献度を出し、その消費者が得た評価軸ポイントの一部を還流できます
  - ToB では評価軸貢献度を算出し、顧客側社員が軸ゴールへ近づいたか確認します
  - クライアントの職場が悪い場合でもパーツ指標側が低く抑えられるなら、供給者は悪影響ヘの寄与が小さいと切り分けできます
  - 現場側が苦痛を浴びていても、供給者は悪影響度 × パーツ係数（例 0.001）程度の薄いペナルティにとどまります
  - 監視義務不履行で損害が出た場合も、罰則を段階設計で抑えられます

- **完全競争市場**

- 次の 4 条件へ近づける仕組みを無料主義で積み上げます
- （1）財の同質性：自由フォークと相互運用で見かけ上の商品を揃えます
  - 社名が変わっても旧ラベルへ加工表示し、現状維持バイアスを保ちつつ切替しやすくします
  - 裏では評価軸が入れ替わっていても表層は同ブランドの更新に見せます
  - AI 加工で好みの外観へ寄せ、価格劣化時は即スイッチしやすくします
  - 二次利用許諾を要さない設計へ寄せます
- （2）情報の完全性：オープンが得である状態と、合理的に全情報を使う意思決定基盤を整えます
- （3）多数の経済主体：薄利でも参入が続く設計で寡占化を抑え、非貢献なら報酬が乗らない旨を明示します
  - 参入メリットを高め、ネットワーク効果の閉じ込めを避けます
- （4）参入の自由：初期費用が高くても加工規格と譲渡市場で利用権を滑らかにします
  - 巨額設備へは評価軸ポイントでアクセス権を買い、後発も工場を使えます
  - 差別化排他よりフォーク解放を評価し、相互運用で即乗換え可能にします
- 上記以外の手段も組み合わせ、4 条件へ漸近させます
