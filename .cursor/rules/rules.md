...
- Code Style and Structure
  ...
  - Use GraphQL , Apollo Server(@apollo/server) , Apollo Client(@apollo/client) , @as-integrations/next
  - できる限り改行しないようにしてください。
...
- Syntax and Formatting
  ...
  - Use declarative JSX.
  - Use the "function" keyword for pure functions.
  - Don't use the arrow function for the function component.

- UI and Styling

  - Use Shadcn UI, and Tailwind version 4 for components and styling.
...
- Prismaにアクセスする場合は、Actionsフォルダにまとめて下さい。
