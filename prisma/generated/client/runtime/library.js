...
var _ = (e, t, r) => ((r = e != null ? pu(fu(e)) : {}), To(t || !e || !e.__esModule ? Fr(r, "default", { value: e, enumerable: !0 }) : r, e)),
...
var Zo = H(($f, zo) => {
  ...
  zo.exports = { supportsColor: oc, stdout: li(ui(!0, Yo.isatty(1))), stderr: li(ui(!0, Yo.isatty(2))) };
});
var ts = H((qf, es) => {
  "use strict";
  var sc = Zo(),
...
var ns = H((Vf, zt) => {
  ...
  var ac = Ho(),
    pi = ts(),
    rs = (e, t, { target: r = "stdout", ...n } = {}) => (pi[r] ? ac.link(e, t) : n.fallback === !1 ? e : typeof n.fallback == "function" ? n.fallback(e, t) : `${e} (\u200B${t}\u200B)`);
...
`,
  ...
  function ps(e) {
    ...
    if (e && e.path && e.path.length > 0)
      if (Array.isArray(e.path)) for (let r of e.path) Ei.existsSync(r) && (t = r.endsWith(".vault") ? r : `${r}.vault`);
...
var Wn = class {
  ...
  Hn = (e) => {
    let t = new Wn(),
      ...
      n = { adapterName: e.adapterName, errorRegistry: t, queryRaw: be(t, e.queryRaw.bind(e)), executeRaw: be(t, e.executeRaw.bind(e)), provider: e.provider, transactionContext: async (...i) => (await r(...i)).map((s) => yu(t, s)) };
  ...
  bu = (e, t) => ({ adapterName: t.adapterName, provider: t.provider, options: t.options, queryRaw: be(e, t.queryRaw.bind(t)), executeRaw: be(e, t.executeRaw.bind(t)), commit: be(e, t.commit.bind(t)), rollback: be(e, t.rollback.bind(t)) });
function be(e, t) {
  return async (...r) => {
    try {
      return await t(...r);
  ...
  return me({
    [Ne]: () => ({
      match: (t) => {
        ...
        return t === void 0 ? (Qe(e).forEach((i) => n(i, void 0)), { matched: !0, selections: r }) : { matched: xe(e, t, n), selections: r };
      },
...
var ni = class e {
  ...
  with(...t) {
    ...
    let o = !1,
      ...
      l = !n.some((u) => xe(u, this.input, a)) || (i && !i(this.input)) ? ri : { matched: !0, value: r(o ? (jr in s ? s[jr] : s) : this.input, this.input) };
...
function tc(e) {
  ...
  t === "linux" &&
    ...
    Br(`Prisma only officially supports Linux on amd64 (x86_64) and arm64 (aarch64) system architectures (detected "${r}" instead). If you are using your own custom Prisma engines, you can ignore this warning, as long as you've compiled the engines for your system architecture "${n}".`);
  let l = "1.1.x";
  if (t === "linux" && i === void 0) {
    let c = dt({ familyDistro: s })
      .with({ familyDistro: "debian" }, () => "Please manually install OpenSSL via `apt-get update -y && apt-get install -y openssl` and try installing Prisma again. If you're running Prisma on Docker, add this command to your Dockerfile, or switch to an image that already has OpenSSL installed.")
...
var bt = 9e15,
  ...
  Li = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -bt, maxE: bt, crypto: !1 },
  Ds,
  Me,
  E = !0,
  sn = "[DecimalError] ",
...
m.cubeRoot = m.cbrt = function () {
  ...
  for (
    ...
    if (((a = n), (l = a.times(a).times(a)), (u = l.plus(c)), (n = M(u.plus(c).times(a), u.plus(l), s + 2, 1)), Y(a.d).slice(0, s) === (r = Y(n.d)).slice(0, s)))
  ...
  return i.isFinite()
    ? i.e >= 0
      ...
      : ((e = o.precision),
        (t = o.rounding),
        (n = i.sd()),
        Math.max(n, e) < 2 * -i.e - 1 ? y(new o(i), e, t, !0) : ((o.precision = r = n - i.e), (i = M(i.plus(1), new o(1).minus(i), r + e, 1)), (o.precision = e + 4), (o.rounding = 1), (i = i.ln()), (o.precision = e), (o.rounding = t), i.times(0.5)))
    : new o(NaN);
};
m.inverseSine = m.asin = function () {
  ...
  return i.isZero()
    ...
    : ((t = i.abs().cmp(1)),
      (r = o.precision),
      (n = o.rounding),
      t !== -1 ? (t === 0 ? ((e = Pe(o, r + 4, n).times(0.5)), (e.s = i.s), e) : new o(NaN)) : ((o.precision = r + 6), (o.rounding = 1), (i = i.div(new o(1).minus(i.times(i)).sqrt().plus(1)).atan()), (o.precision = r), (o.rounding = n), i.times(2)));
};
...
m.logarithm = m.log = function (e) {
  ...
  if (((E = !1), (a = p + f), (s = He(u, a)), (n = t ? on(c, a + 10) : He(e, a)), (l = M(s, n, a, 1)), ir(l.d, (i = p), d)))
    do
...
m.squareRoot = m.sqrt = function () {
  ...
  for (
    E = !1,
      u = Math.sqrt(+s),
      u == 0 || u == 1 / 0 ? ((t = Y(a)), (t.length + l) % 2 == 0 && (t += "0"), (u = Math.sqrt(t)), (l = re((l + 1) / 2) - (l < 0 || l % 2)), u == 1 / 0 ? (t = "5e" + l) : ((t = u.toExponential()), (t = t.slice(0, t.indexOf("e") + 1) + l)), (n = new c(t))) : (n = new c(u.toString())),
      r = (l = c.precision) + 3;
    ;

  )
    if (((o = n), (n = o.plus(M(s, o, r + 2, 1)).times(0.5)), Y(o.d).slice(0, r) === (t = Y(n.d)).slice(0, r)))
...
m.tangent = m.tan = function () {
  ...
  return r.isFinite()
    ? r.isZero()
      ? new n(r)
      : ((e = n.precision), (t = n.rounding), (n.precision = e + 10), (n.rounding = 1), (r = r.sin()), (r.s = 1), (r = M(r, new n(1).minus(r.times(r)).sqrt(), e + 10, 0)), (n.precision = e), (n.rounding = t), y(Me == 2 || Me == 4 ? r.neg() : r, e, t, !0))
    : new n(NaN);
};
...
m.toPower = m.pow = function (e) {
  ...
  return (
    (r = Q(+a, u)),
    (t = r == 0 || !isFinite(r) ? re(u * (Math.log("0." + Y(a.d)) / Math.LN10 + a.e + 1)) : new l(r + "").e),
    t > l.maxE + 1 || t < l.minE - 1
      ...
      : ((E = !1),
        ...
        i.d && ((i = y(i, n + 5, 1)), ir(i.d, n, o) && ((t = n + 10), (i = y(Mi(e.times(He(a, t + r)), t), t + 5, 1)), +Y(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = y(i, n + 1, 0)))),
        (i.s = s),
        (E = !0),
        (l.rounding = o),
        y(i, n, o))
  ...
  return (
    ...
    n == null
      ? t < 3
        ...
        : (s = (((r < 4 && a + 1 == o) || (r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 100) | 0) == Q(10, t - 2) - 1) || ((a == o / 2 || a == 0) && ((e[i + 1] / o / 100) | 0) == 0))
      : t < 4
        ? (t == 0 ? (a = (a / 1e3) | 0) : t == 1 ? (a = (a / 100) | 0) : t == 2 && (a = (a / 10) | 0), (s = ((n || r < 4) && a == 9999) || (!n && r > 3 && a == 4999)))
        : (s = (((n || r < 4) && a + 1 == o) || (!n && r > 3 && a + 1 == o / 2)) && ((e[i + 1] / o / 1e3) | 0) == Q(10, t - 3) - 1),
    s
  );
}
function en(e, t, r) {
          ...
          (d = 0),
            ...
            u < 0
              ? ((A = R[0]),
                z != k && (A = A * l + (R[1] || 0)),
                (d = (A / Oe) | 0),
                d > 1 ? (d >= l && (d = l - 1), (h = e(L, d, l)), (O = h.length), (k = R.length), (u = t(h, R, O, k)), u == 1 && (d--, r(h, z < O ? pt : L, O, l))) : (d == 0 && (u = d = 1), (h = L.slice())),
                (O = h.length),
                O < k && h.unshift(0),
                r(R, h, k, l),
                u == -1 && ((k = R.length), (u = t(L, R, z, k)), u < 1 && (d++, r(R, z < k ? pt : L, k, l))),
                (k = R.length))
              : u === 0 && (d++, (R = [0])),
            (C[p++] = d),
...
function y(e, t, r, n) {
  ...
  e: if (t != null) {
    ...
    if (
      ...
      (u = r < 4 ? (l || n) && (r == 0 || r == (e.s < 0 ? 3 : 2)) : l > 5 || (l == 5 && (r == 4 || n || (r == 6 && (o > 0 ? (s > 0 ? c / Q(10, i - s) : 0) : p[d - 1]) % 10 & 1) || r == (e.s < 0 ? 8 : 7)))),
      t < 1 || !p[0])
    )
      return (p.length = 0), u ? ((t -= e.e + 1), (p[0] = Q(10, (b - (t % b)) % b)), (e.e = -t || 0)) : (p[0] = e.e = 0), e;
    if ((o == 0 ? ((p.length = d), (a = 1), d--) : ((p.length = d + 1), (a = Q(10, b - o)), (p[d] = s > 0 ? ((c / Q(10, i - s)) % Q(10, s) | 0) * a : 0)), u))
      for (;;)
        if (d == 0) {
...
function Mi(e, t) {
  ...
  for (t == null ? ((E = !1), (l = g)) : (l = t), a = new d(0.03125); e.e > -2; ) (e = e.times(a)), (p += 5);
  for (n = ((Math.log(Q(2, p)) / Math.LN10) * 2 + 5) | 0, l += n, r = o = s = new d(1), d.precision = l; ; ) {
    if (((o = y(o.times(e), l, 1)), (r = r.times(++c)), (a = s.plus(M(o, r, l, 1))), Y(a.d).slice(0, l) === Y(s.d).slice(0, l))) {
      ...
      if (t == null)
        if (u < 3 && ir(s.d, l - n, f, u)) (d.precision = l += 10), (r = o = a = new d(1)), (c = 0), u++;
...
function He(e, t) {
  ...
  for (p = h, l = s = h = M(h.minus(1), h.plus(1), c, 1), d = y(h.times(h), c, 1), i = 3; ; ) {
    if (((s = y(s.times(d), c, 1)), (u = l.plus(M(s, new v(i), c, 1))), Y(u.d).slice(0, c) === Y(l.d).slice(0, c)))
      if (((l = l.times(2)), o !== 0 && (l = l.plus(on(v, c + 2, R).times(o + ""))), (l = M(l, new v(f), c, 1)), t == null))
        if (ir(l.d, c - g, C, a)) (v.precision = c += g), (u = s = h = M(p.minus(1), p.plus(1), c, 1)), (d = y(h.times(h), c, 1)), (i = a = 1);
...
function Jc(e, t) {
  ...
  for (
    o = t.search(/p/i), o > 0 ? ((l = +t.slice(o + 1)), (t = t.substring(2, o))) : (t = t.slice(2)), o = t.indexOf("."), s = o >= 0, n = e.constructor, s && ((t = t.replace(".", "")), (a = t.length), (o = a - o), (i = qs(n, new n(r), o, o * 2))), u = en(t, r, ge), c = u.length - 1, o = c;
    u[o] === 0;
    --o
  )
    u.pop();
...
function $i(e, t, r, n) {
  ...
  if ((g ? (se(r, 1, Ye), n === void 0 ? (n = f.rounding) : se(n, 0, 8)) : ((r = f.precision), (n = f.rounding)), !e.isFinite())) c = js(e);
    ...
    for (c = ve(e), s = c.indexOf("."), g ? ((i = 2), t == 16 ? (r = r * 4 - 3) : t == 8 && (r = r * 3 - 2)) : (i = t), s >= 0 && ((c = c.replace(".", "")), (d = new f(1)), (d.e = c.length - s), (d.d = en(ve(d), 10, i)), (d.e = d.d.length)), p = en(c, 10, i), o = l = p.length; p[--l] == 0; )
      p.pop();
    if (!p[0]) c = g ? "0p+0" : "0";
    else {
      if (
        (s < 0 ? o-- : ((e = new f(e)), (e.d = p), (e.e = o), (e = M(e, d, r, n, 0, i)), (p = e.d), (o = e.e), (u = Ds)),
        (s = p[r]),
        (a = i / 2),
        (u = u || p[r + 1] !== void 0),
      ...
      : !e.d && !t.d
        ...
        : !t.d || e.isZero()
          ...
          : !e.d || t.isZero()
            ...
            : t.s < 0
              ? ((this.precision = o), (this.rounding = 1), (r = this.atan(M(e, t, o, 1))), (t = Pe(this, o, 1)), (this.precision = n), (this.rounding = i), (r = e.s < 0 ? r.minus(t) : r.plus(t)))
...
function sp(e) {
  ...
  var t,
    ...
    n,
    i = e.defaults === !0,
    o = ["precision", 1, Ye, "rounding", 0, 8, "toExpNeg", -bt, 0, "toExpPos", 0, bt, "maxE", 0, bt, "minE", -bt, 0, "modulo", 0, 9];
...
x.languages.javascript = x.languages.extend("clike", {
  "class-name": [x.languages.clike["class-name"], { pattern: /(^|[^$\w\xA0-\uFFFF])[_$A-Z\xA0-\uFFFF][$\w\xA0-\uFFFF]*(?=\.(?:prototype|constructor))/, lookbehind: !0 }],
  keyword: [
...
x.languages.insertBefore("javascript", "keyword", {
  ...
  parameter: [
    { pattern: /(function(?:\s+[_$A-Za-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*)?\s*\(\s*)(?!\s)(?:[^()]|\([^()]*\))+?(?=\s*\))/, lookbehind: !0, inside: x.languages.javascript },
    { pattern: /[_$a-z\xA0-\uFFFF][$\w\xA0-\uFFFF]*(?=\s*=>)/i, inside: x.languages.javascript },
    { pattern: /(\(\s*)(?!\s)(?:[^()]|\([^()]*\))+?(?=\s*\)\s*=>)/, lookbehind: !0, inside: x.languages.javascript },
    {
      pattern:
...
var qp = { red: de, gray: Jt, dim: ke, bold: K, underline: X, highlightSource: (e) => e.highlight() },
  Vp = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function Pn({ args: e, errors: t, errorFormat: r, callsite: n, originalMethod: i, clientVersion: o, globalOmit: s }) {
  ...
  let { message: l, args: u } = xn(a, r),
    c = dn({ message: l, callsite: n, originalMethod: i, showColors: r === "pretty", callArguments: u });
...
function xa(e, t) {
  ...
  for (let n in e) {
    let i = e[n],
      o = t.nestArgument(n);
    Ae(i) ||
      (i !== void 0 ? (r[n] = wa(i, o)) : t.isPreviewFeatureOn("strictUndefinedChecks") && t.throwValidationError({ kind: "InvalidArgumentValue", argumentPath: o.getArgumentPath(), selectionPath: t.getSelectionPath(), argument: { name: t.getArgumentName(), typeNames: [] }, underlyingError: Ea }));
  }
  return r;
}
function Sd(e, t) {
...
var qa = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  Va = (e, t, r) => qa(t).reduceRight((n, i, o, s) => Object.assign({}, Xi(e, s.slice(0, o)), { [i]: n }), r);
function Zd(e, t) {
...
function to(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [nm(e, t), om(e, t), hr(r), ie("name", () => t), ie("$name", () => t), ie("$parent", () => e._appliedParent)];
  return ye({}, n);
}
function nm(e, t) {
  let r = Se(t),
...
function Er(e) {
  ...
  if (typeof e == "object") {
    let t = {};
    for (let r in e) r === "__proto__" ? Object.defineProperty(t, r, { value: Er(e[r]), configurable: !0, enumerable: !0, writable: !0 }) : (t[r] = Er(e[r]));
    return t;
  }
  Fe(e, "Unknown value");
}
...
async function cl(e, t) {
  ...
  let o = await nt(),
    ...
    c = { searchedLocations: i, generatorBinaryTargets: s, generator: t.generator, runtimeBinaryTarget: o, queryEngineName: pl(e, o), expectedLocation: wr.default.relative(process.cwd(), t.dirname), errorStack: new Error().stack },
    p;
...
async function ym(engineType, config) {
  let binaryTarget = await nt(),
    ...
    searchLocations = [config.dirname, wr.default.resolve(dirname, ".."), config.generator?.output?.value ?? dirname, wr.default.resolve(dirname, "../../../.prisma/client"), "/tmp/prisma-engines", config.cwd];
    ...
    async withRetry(t) {
      for (let r = 0; ; r++) {
        ...
        try {
          ...
          this.logEmitter.emit("warn", { message: `Attempt ${r + 1}/${vl} failed for ${t.actionGerund}: ${i.message ?? "(unknown)"}`, timestamp: new Date(), target: "" });
          let o = await yl(r);
  ...
  logger(t) {
    ...
    r &&
      ...
      Im(r)
        ...
        : Om(r)
          ? (this.loggerRustPanic = new ce(yo(this, `${r.message}: ${r.reason} in ${r.file}:${r.line}:${r.column}`), this.config.clientVersion))
        ...
        (this.dataloader = new jn({
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === "itx" ? Jl(n.transaction) : void 0,
              o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: vo(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
...
function lu(e) {
  class t {
    constructor(n) {
      ...
      let o = { rootEnvPath: e.relativeEnvPaths.rootEnvPath && Nr.default.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && Nr.default.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
        s;
      if (n?.adapter) {
        s = Hn(n.adapter);
      ...
      try {
        ...
        let g = { name: "serialize" },
          h = this._tracingHelper.runInChildSpan(g, () =>
            Cn({ modelName: l, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }),
          );
        return (
...
var ef = new Set(["toJSON", "$$typeof", "asymmetricMatch", Symbol.iterator, Symbol.toStringTag, Symbol.isConcatSpreadable, Symbol.toPrimitive]);
function uu(e) {
  return new Proxy(e, {
    get(t, r) {
