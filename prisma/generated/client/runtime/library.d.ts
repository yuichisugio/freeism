...
export declare type DynamicModelExtensionFluentApi<TypeMap extends TypeMapDef, M extends PropertyKey, P extends PropertyKey, Null, ClientOptions> = {
  [K in keyof TypeMap["model"][M]["payload"]["objects"]]: <A>(args?: Exact<A, Path<TypeMap["model"][M]["operations"][P]["args"]["select"], [K]>>) => PrismaPromise<
    ...
    | Null
  > &
    DynamicModelExtensionFluentApi<TypeMap, (TypeMap["model"][M]["payload"]["objects"][K] & {})["name"], P, Null | Select<TypeMap["model"][M]["payload"]["objects"][K], null>, ClientOptions>;
};

export declare type DynamicModelExtensionFnResult<TypeMap extends TypeMapDef, M extends PropertyKey, A, P extends PropertyKey, Null, ClientOptions> = P extends FluentOperation
  ? DynamicModelExtensionFluentApi<TypeMap, M, P, Null, ClientOptions> & PrismaPromise<DynamicModelExtensionFnResultBase<TypeMap, M, A, P, ClientOptions> | Null>
...
export declare type DynamicModelExtensionOperationFn<TypeMap extends TypeMapDef, M extends PropertyKey, P extends PropertyKey, ClientOptions> = {} extends TypeMap["model"][M]["operations"][P]["args"]
  ? <A extends TypeMap["model"][M]["operations"][P]["args"]>(args?: Exact<A, TypeMap["model"][M]["operations"][P]["args"]>) => DynamicModelExtensionFnResult<TypeMap, M, A, P, DynamicModelExtensionFnResultNull<P>, ClientOptions>
  : <A extends TypeMap["model"][M]["operations"][P]["args"]>(args: Exact<A, TypeMap["model"][M]["operations"][P]["args"]>) => DynamicModelExtensionFnResult<TypeMap, M, A, P, DynamicModelExtensionFnResultNull<P>, ClientOptions>;
...
export declare type ExtendsHook<
...
export declare function getPrismaClient(config: GetPrismaClientConfig): {
  new (optionsArg?: PrismaClientOptions): {
     ...
     * @returns
     */
    _transactionWithCallback({ callback, options }: { callback: (client: Client) => Promise<unknown>; options?: TransactionOptions_2 }): Promise<unknown>;
 ...
 */
export declare type InputJsonArray = {} & ReadonlyArray<InputJsonValue | null>;
...
declare function resolveDatasourceUrl({ inlineDatasources, overrideDatasources, env, clientVersion }: { inlineDatasources: GetPrismaClientConfig["inlineDatasources"]; overrideDatasources: Datasources; env: Record<string, string | undefined>; clientVersion: string }): string;
...
declare namespace Result_3 {
  export { Operation, FluentOperation, Count, GetFindResult, SelectablePayloadFields, SelectField, DefaultSelection, UnwrapPayload, ApplyOmit, OmitValue, GetCountResult, Aggregate, GetAggregateResult, GetBatchResult, GetGroupByResult, GetResult, ExtractGlobalOmit };
}
