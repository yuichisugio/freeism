...
var Fe = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports),
  ...
  li = (e, t, r, n) => {
    if ((t && typeof t == "object") || typeof t == "function") for (let i of Ea(t)) !xa.call(e, i) && i !== r && sr(e, i, { get: () => t[i], enumerable: !(n = wa(t, i)) || n.enumerable });
    return e;
  };
var Je = (e, t, r) => ((r = e != null ? ya(ba(e)) : {}), li(t || !e || !e.__esModule ? sr(r, "default", { value: e, enumerable: !0 }) : r, e)),
...
var Ai = Fe((Ke) => {
  ...
  function fi(e, t, r) {
    ...
    if (me(e, ArrayBuffer) || (e && me(e.buffer, ArrayBuffer)) || (typeof SharedArrayBuffer < "u" && (me(e, SharedArrayBuffer) || (e && me(e.buffer, SharedArrayBuffer))))) return hi(e, t, r);
...
var gn = class {
  ...
  hn = (e) => {
    let t = new gn(),
      ...
      n = { adapterName: e.adapterName, errorRegistry: t, queryRaw: de(t, e.queryRaw.bind(e)), executeRaw: de(t, e.executeRaw.bind(e)), provider: e.provider, transactionContext: async (...i) => (await r(...i)).map((s) => za(t, s)) };
  ...
  Ya = (e, t) => ({ adapterName: t.adapterName, provider: t.provider, options: t.options, queryRaw: de(e, t.queryRaw.bind(t)), executeRaw: de(e, t.executeRaw.bind(t)), commit: de(e, t.commit.bind(t)), rollback: de(e, t.rollback.bind(t)) });
function de(e, t) {
  return async (...r) => {
    try {
      return await t(...r);
...
var Xe = 9e15,
  ...
  An = { precision: 20, rounding: 4, modulo: 1, toExpNeg: -7, toExpPos: 21, minE: -Xe, maxE: Xe, crypto: !1 },
  co,
  Te,
  N = !0,
  xr = "[DecimalError] ",
...
C.cosine = C.cos = function () {
  var e,
    ...
    r = this,
    n = r.constructor;
  return r.d ? (r.d[0] ? ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + k), (n.rounding = 1), (r = Tl(n, bo(n, r))), (n.precision = e), (n.rounding = t), I(Te == 2 || Te == 3 ? r.neg() : r, e, t, !0)) : new n(1)) : new n(NaN);
};
...
C.logarithm = C.log = function (e) {
  ...
  if (((N = !1), (a = h + S), (s = ke(f, a)), (n = t ? br(g, a + 10) : ke(e, a)), (l = $(s, n, a, 1)), kt(l.d, (i = h), v)))
    do
...
C.sine = C.sin = function () {
  var e,
    ...
    r = this,
    n = r.constructor;
  return r.isFinite() ? (r.isZero() ? new n(r) : ((e = n.precision), (t = n.rounding), (n.precision = e + Math.max(r.e, r.sd()) + k), (n.rounding = 1), (r = Rl(n, bo(n, r))), (n.precision = e), (n.rounding = t), I(Te > 2 ? r.neg() : r, e, t, !0))) : new n(NaN);
};
C.squareRoot = C.sqrt = function () {
  ...
  for (
    N = !1,
      f = Math.sqrt(+s),
      f == 0 || f == 1 / 0 ? ((t = z(a)), (t.length + l) % 2 == 0 && (t += "0"), (f = Math.sqrt(t)), (l = X((l + 1) / 2) - (l < 0 || l % 2)), f == 1 / 0 ? (t = "5e" + l) : ((t = f.toExponential()), (t = t.slice(0, t.indexOf("e") + 1) + l)), (n = new g(t))) : (n = new g(f.toString())),
      r = (l = g.precision) + 3;
    ;
...
C.tangent = C.tan = function () {
  ...
  return r.isFinite()
    ? r.isZero()
      ? new n(r)
      : ((e = n.precision), (t = n.rounding), (n.precision = e + 10), (n.rounding = 1), (r = r.sin()), (r.s = 1), (r = $(r, new n(1).minus(r.times(r)).sqrt(), e + 10, 0)), (n.precision = e), (n.rounding = t), I(Te == 2 || Te == 4 ? r.neg() : r, e, t, !0))
    : new n(NaN);
};
C.times = C.mul = function (e) {
  ...
  for (r = X(g.e / k) + X(e.e / k), l = v.length, f = S.length, l < f && ((o = v), (v = S), (S = o), (s = l), (l = f), (f = s)), o = [], s = l + f, n = s; n--; ) o.push(0);
  for (n = f; --n >= 0; ) {
...
C.toExponential = function (e, t) {
  var r,
    n = this,
    i = n.constructor;
  return e === void 0 ? (r = ge(n, !0)) : (oe(e, 0, De), t === void 0 ? (t = i.rounding) : oe(t, 0, 8), (n = I(new i(n), e + 1, t)), (r = ge(n, !0, e + 1))), n.isNeg() && !n.isZero() ? "-" + r : r;
};
C.toFixed = function (e, t) {
  var r,
    ...
    i = this,
    o = i.constructor;
  return e === void 0 ? (r = ge(i)) : (oe(e, 0, De), t === void 0 ? (t = o.rounding) : oe(t, 0, 8), (n = I(new o(i), e + i.e + 1, t)), (r = ge(n, !1, e + n.e + 1))), i.isNeg() && !i.isZero() ? "-" + r : r;
};
C.toFraction = function (e) {
  var t,
    ...
    A = S.constructor;
  if (!R) return new A(S);
  if (((f = r = new A(1)), (n = l = new A(0)), (t = new A(n)), (o = t.e = ho(R) - S.e - 1), (s = o % k), (t.d[0] = W(10, s < 0 ? k + s : s)), e == null)) e = o > 0 ? t : f;
  else {
...
C.toPower = C.pow = function (e) {
  ...
  if (((t = X(e.e / k)), t >= e.d.length - 1 && (r = f < 0 ? -f : f) <= Pl)) return (i = yo(l, a, r, n)), e.s < 0 ? new l(1).div(i) : I(i, n, o);
  if (((s = a.s), s < 0)) {
  ...
  return (
    ...
    t > l.maxE + 1 || t < l.minE - 1
      ...
      : ((N = !1),
        ...
        i.d && ((i = I(i, n + 5, 1)), kt(i.d, n, o) && ((t = n + 10), (i = I(In(e.times(ke(a, t + r)), t), t + 5, 1)), +z(i.d).slice(n + 1, n + 15) + 1 == 1e14 && (i = I(i, n + 1, 0)))),
        (i.s = s),
        (N = !0),
        (l.rounding = o),
        I(i, n, o))
...
var $ = (function () {
  ...
  return function (n, i, o, s, a, l) {
    var f,
      ...
      Y = n.d,
      V = i.d;
    if (!Y || !Y[0] || !V || !V[0]) return new or(!n.s || !i.s || (Y ? V && Y[0] == V[0] : !V) ? NaN : (Y && Y[0] == 0) || !V ? on * 0 : on / 0);
    for (l ? ((S = 1), (g = n.e - i.e)) : ((l = ce), (S = k), (g = X(n.e / S) - X(i.e / S))), ue = V.length, Pt = Y.length, M = new or(on), U = M.d = [], h = 0; V[h] == (Y[h] || 0); h++);
    if ((V[h] > (Y[h] || 0) && g--, o == null ? ((J = o = or.precision), (s = or.rounding)) : a ? (J = o + (n.e - i.e) + 1) : (J = o), J < 0)) U.push(1), (R = !0);
    else {
      if (((J = (J / S + 2) | 0), (h = 0), ue == 1)) {
        for (v = 0, V = V[0], J++; (h < Pt || v) && J--; h++) (rn = v * l + (Y[h] || 0)), (U[h] = (rn / V) | 0), (v = rn % V | 0);
        R = v || h < Pt;
      } else {
        for (v = (l / (V[0] + 1)) | 0, v > 1 && ((V = e(V, v, l)), (Y = e(Y, v, l)), (ue = V.length), (Pt = Y.length)), nr = ue, O = Y.slice(0, ue), F = O.length; F < ue; ) O[F++] = 0;
          ...
          (v = 0),
            ...
            f < 0
              ? ((L = O[0]),
                ue != F && (L = L * l + (O[1] || 0)),
                (v = (L / nn) | 0),
                v > 1 ? (v >= l && (v = l - 1), (A = e(V, v, l)), (D = A.length), (F = O.length), (f = t(A, O, D, F)), f == 1 && (v--, r(A, ue < D ? ir : V, D, l))) : (v == 0 && (f = v = 1), (A = V.slice())),
                (D = A.length),
                D < F && A.unshift(0),
                r(O, A, F, l),
                f == -1 && ((F = O.length), (f = t(V, O, ue, F)), f < 1 && (v++, r(O, ue < F ? ir : V, F, l))),
                (F = O.length))
              : f === 0 && (v++, (O = [0])),
            (U[h++] = v),
...
function In(e, t) {
  ...
  for (n = ((Math.log(W(2, h)) / Math.LN10) * 2 + 5) | 0, l += n, r = o = s = new v(1), v.precision = l; ; ) {
    if (((o = I(o.times(e), l, 1)), (r = r.times(++g)), (a = s.plus($(o, r, l, 1))), z(a.d).slice(0, l) === z(s.d).slice(0, l))) {
      ...
      if (t == null)
        if (f < 3 && kt(s.d, l - n, S, f)) (v.precision = l += 10), (r = o = a = new v(1)), (g = 0), f++;
...
function ke(e, t) {
  ...
  } else return (f = br(M, g + 2, O).times(o + "")), (A = ke(new M(n + "." + r.slice(1)), g - R).plus(f)), (M.precision = O), t == null ? I(A, O, U, (N = !0)) : A;
  for (h = A, l = s = A = $(A.minus(1), A.plus(1), g, 1), v = I(A.times(A), g, 1), i = 3; ; ) {
    if (((s = I(s.times(v), g, 1)), (f = l.plus($(s, new M(i), g, 1))), z(f.d).slice(0, g) === z(l.d).slice(0, g)))
      if (((l = l.times(2)), o !== 0 && (l = l.plus(br(M, g + 2, O).times(o + ""))), (l = $(l, new M(S), g, 1)), t == null))
        if (kt(l.d, g - R, U, a)) (M.precision = g += R), (f = s = A = $(h.minus(1), h.plus(1), g, 1)), (v = I(A.times(A), g, 1)), (i = a = 1);
...
function Cl(e, t) {
  ...
  for (
    o = t.search(/p/i), o > 0 ? ((l = +t.slice(o + 1)), (t = t.substring(2, o))) : (t = t.slice(2)), o = t.indexOf("."), s = o >= 0, n = e.constructor, s && ((t = t.replace(".", "")), (a = t.length), (o = a - o), (i = yo(n, new n(r), o, o * 2))), f = hr(t, r, ce), g = f.length - 1, o = g;
    f[o] === 0;
    --o
  )
    f.pop();
  return o < 0 ? new n(e.s * 0) : ((e.e = Pr(f, g)), (e.d = f), (N = !1), s && (e = $(e, i, a * 4)), l && (e = e.times(Math.abs(l) < 54 ? W(2, l) : Be.pow(2, l))), (N = !0), e);
}
function Rl(e, t) {
  var r,
    n = t.d.length;
...
function kn(e, t, r, n) {
  var i,
    ...
    S = e.constructor,
    R = r !== void 0;
  if ((R ? (oe(r, 1, De), n === void 0 ? (n = S.rounding) : oe(n, 0, 8)) : ((r = S.precision), (n = S.rounding)), !e.isFinite())) g = Eo(e);
  else {
    ...
    if (!h[0]) g = R ? "0p+0" : "0";
      ...
      if (
        (s < 0 ? o-- : ((e = new S(e)), (e.d = h), (e.e = o), (e = $(e, v, r, n, 0, i)), (h = e.d), (o = e.e), (f = co)),
        (s = h[r]),
        (a = i / 2),
        (f = f || h[r + 1] !== void 0),
...
function xo(e) {
  ...
  function i(o) {
    ...
    if (l === "string") return (a = o.charCodeAt(0)) === 45 ? ((o = o.slice(1)), (f.s = -1)) : (a === 43 && (o = o.slice(1)), (f.s = 1)), go.test(o) ? yr(f, o) : Cl(f, o);
...
var gu = { red: ze, gray: qi, dim: pr, bold: cr, underline: _i, highlightSource: (e) => e.highlight() },
  hu = { red: (e) => e, gray: (e) => e, dim: (e) => e, bold: (e) => e, underline: (e) => e, highlightSource: (e) => e };
...
function zu(e, t, r) {
  let n = {};
  return e.modelOrType && !e.isRawAction() && ((n.$composites = !0), (n.$scalars = !0)), t && Yu(n, t, e), Zu(n, r, e), n;
}
function Yu(e, t, r) {
...
function Wo(e, t) {
  ...
  for (let n in e) {
    let i = e[n],
      o = t.nestArgument(n);
    be(i) ||
      (i !== void 0 ? (r[n] = Qo(i, o)) : t.isPreviewFeatureOn("strictUndefinedChecks") && t.throwValidationError({ kind: "InvalidArgumentValue", argumentPath: o.getArgumentPath(), selectionPath: t.getSelectionPath(), argument: { name: t.getArgumentName(), typeNames: [] }, underlyingError: Jo }));
  }
  return r;
}
function ec(e, t) {
...
var ps = (e) => (Array.isArray(e) ? e : e.split(".")),
  ...
  ms = (e, t, r) => ps(t).reduceRight((n, i, o, s) => Object.assign({}, Gn(e, s.slice(0, o)), { [i]: n }), r);
function fc(e, t) {
...
function Qn(e, t) {
  let r = e._extensions.getAllModelExtensions(t) ?? {},
    n = [Ec(e, t), xc(e, t), Vt(r), te("name", () => t), te("$name", () => t), te("$parent", () => e._appliedParent)];
  return pe({}, n);
}
function Ec(e, t) {
  let r = Ee(t),
...
function Gt(e) {
  ...
  if (typeof e == "object") {
    let t = {};
    for (let r in e) r === "__proto__" ? Object.defineProperty(t, r, { value: Gt(e[r]), configurable: !0, enumerable: !0, writable: !0 }) : (t[r] = Gt(e[r]));
    return t;
  }
  Pe(e, "Unknown value");
}
...
function Ss({ postinstall: e, ciName: t, clientVersion: r }) {
  if ((Rs("checkPlatformCaching:postinstall", e), Rs("checkPlatformCaching:ciName", t), e === !0 && t && t in As)) {
...
var Ls = 3,
  ...
  Et = class {
    ...
    extractHostAndApiKey() {
      ...
      if (o !== "prisma:" && o !== dr) throw new qe(`Error validating datasource \`${r}\`: the URL must start with the protocol \`prisma://\``, t);
      let l = a.get("api_key");
    ...
    async handleError(t) {
      if (t instanceof Ve) throw (await this.uploadSchema(), new ht({ clientVersion: this.clientVersion, cause: t }));
      if (t) throw t;
    }
        ...
        (this.dataloader = new Xr({
          ...
          singleLoader: async (n) => {
            let i = n.transaction?.kind === "itx" ? ta(n.transaction) : void 0,
              o = await this.client._engine.request(n.protocolQuery, { traceparent: this.client._tracingHelper.getTraceParent(), interactiveTransaction: i, isWrite: ai(n.protocolQuery.action), customDataProxyFetch: n.customDataProxyFetch });
...
It should have this form: { url: "CONNECTION_STRING" }`);
    ...
    adapter: (e, t) => {
      ...
      if (!zr(t).includes("driverAdapters")) throw new q('"adapter" property can only be provided to PrismaClient constructor when "driverAdapters" preview feature is enabled.');
...
function fa(e) {
  class t {
    constructor(n) {
      ...
      let o = { rootEnvPath: e.relativeEnvPaths.rootEnvPath && Rt.resolve(e.dirname, e.relativeEnvPaths.rootEnvPath), schemaEnvPath: e.relativeEnvPaths.schemaEnvPath && Rt.resolve(e.dirname, e.relativeEnvPaths.schemaEnvPath) },
        s;
      if (n?.adapter) {
        s = hn(n.adapter);
      ...
      try {
        ...
        let R = { name: "serialize" },
          A = this._tracingHelper.runInChildSpan(R, () =>
            Ur({ modelName: l, runtimeDataModel: this._runtimeDataModel, action: a, args: n, clientMethod: i, callsite: s, extensions: this._extensions, errorFormat: this._errorFormat, clientVersion: this._clientVersion, previewFeatures: this._previewFeatures, globalOmit: this._globalOmit }),
          );
        return (
