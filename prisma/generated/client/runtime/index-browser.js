  ...
  return r.isFinite()
    ? r.e >= 0
      ...
      : ((e = s.precision),
        (n = s.rounding),
        (t = r.sd()),
        Math.max(t, e) < 2 * -r.e - 1 ? p(new s(r), e, n, !0) : ((s.precision = i = t - r.e), (r = S(r.plus(1), new s(1).minus(r), i + e, 1)), (s.precision = e + 4), (s.rounding = 1), (r = r.ln()), (s.precision = e), (s.rounding = n), r.times(0.5)))
    : new s(NaN);
};
h.inverseSine = h.asin = function () {
  ...
  return r.isZero()
    ...
    : ((n = r.abs().cmp(1)),
      (i = s.precision),
      (t = s.rounding),
      n !== -1 ? (n === 0 ? ((e = D(s, i + 4, t).times(0.5)), (e.s = r.s), e) : new s(NaN)) : ((s.precision = i + 6), (s.rounding = 1), (r = r.div(new s(1).minus(r.times(r)).sqrt().plus(1)).atan()), (s.precision = i), (s.rounding = t), r.times(2)));
};
...
h.logarithm = h.log = function (e) {
  ...
  if (((w = !1), (u = a + g), (o = B(f, u)), (t = n ? oe(c, u + 10) : B(e, u)), (l = S(o, t, u, 1)), x(l.d, (r = a), d)))
    do
...
h.squareRoot = h.sqrt = function () {
  ...
  for (
    w = !1,
      f = Math.sqrt(+o),
      f == 0 || f == 1 / 0 ? ((n = O(u)), (n.length + l) % 2 == 0 && (n += "0"), (f = Math.sqrt(n)), (l = R((l + 1) / 2) - (l < 0 || l % 2)), f == 1 / 0 ? (n = "5e" + l) : ((n = f.toExponential()), (n = n.slice(0, n.indexOf("e") + 1) + l)), (t = new c(n))) : (t = new c(f.toString())),
      i = (l = c.precision) + 3;
    ;
...
h.tangent = h.tan = function () {
  ...
  return i.isFinite()
    ? i.isZero()
      ? new t(i)
      : ((e = t.precision), (n = t.rounding), (t.precision = e + 10), (t.rounding = 1), (i = i.sin()), (i.s = 1), (i = S(i, new t(1).minus(i.times(i)).sqrt(), e + 10, 0)), (t.precision = e), (t.rounding = n), p(Z == 2 || Z == 4 ? i.neg() : i, e, n, !0))
    : new t(NaN);
};
...
h.toPower = h.pow = function (e) {
  ...
  return (
    (i = C(+u, f)),
    (n = i == 0 || !isFinite(i) ? R(f * (Math.log("0." + O(u.d)) / Math.LN10 + u.e + 1)) : new l(i + "").e),
    n > l.maxE + 1 || n < l.minE - 1
      ...
      : ((w = !1),
        ...
        r.d && ((r = p(r, t + 5, 1)), x(r.d, t, s) && ((n = t + 10), (r = p(Se(e.times(B(u, n + i)), n), n + 5, 1)), +O(r.d).slice(t + 1, t + 15) + 1 == 1e14 && (r = p(r, t + 1, 0)))),
        (r.s = o),
        (w = !0),
        (l.rounding = s),
        p(r, t, s))
          ...
          (d = 0),
            ...
            f < 0
              ? ((Y = E[0]),
                T != P && (Y = Y * l + (E[1] || 0)),
                (d = (Y / ae) | 0),
                d > 1 ? (d >= l && (d = l - 1), (N = e(k, d, l)), (A = N.length), (P = E.length), (f = n(N, E, A, P)), f == 1 && (d--, i(N, T < A ? y : k, A, l))) : (d == 0 && (f = d = 1), (N = k.slice())),
                (A = N.length),
                A < P && N.unshift(0),
                i(E, N, P, l),
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      ...
      (f = i < 4 ? (l || t) && (i == 0 || i == (e.s < 0 ? 3 : 2)) : l > 5 || (l == 5 && (i == 4 || t || (i == 6 && (s > 0 ? (o > 0 ? c / C(10, r - o) : 0) : a[d - 1]) % 10 & 1) || i == (e.s < 0 ? 8 : 7)))),
      n < 1 || !a[0])
    )
...
function B(e, n) {
  ...
  for (a = N, l = o = N = S(N.minus(1), N.plus(1), c, 1), d = p(N.times(N), c, 1), r = 3; ; ) {
    if (((o = p(o.times(d), c, 1)), (f = l.plus(S(o, new M(r), c, 1))), O(f.d).slice(0, c) === O(l.d).slice(0, c)))
      if (((l = l.times(2)), s !== 0 && (l = l.plus(oe(M, c + 2, E).times(s + ""))), (l = S(l, new M(g), c, 1)), n == null))
        if (x(l.d, c - v, q, u)) (M.precision = c += v), (f = o = N = S(a.minus(1), a.plus(1), c, 1)), (d = p(N.times(N), c, 1)), (r = u = 1);
...
function on(e, n) {
  ...
  for (
    s = n.search(/p/i), s > 0 ? ((l = +n.slice(s + 1)), (n = n.substring(2, s))) : (n = n.slice(2)), s = n.indexOf("."), o = s >= 0, t = e.constructor, o && ((n = n.replace(".", "")), (u = n.length), (s = u - s), (r = Ue(t, new t(i), s, s * 2))), f = ie(n, i, L), c = f.length - 1, s = c;
    f[s] === 0;
    --s
  )
    f.pop();
...
function ke(e, n, i, t) {
  ...
  if ((v ? (_(i, 1, $), t === void 0 ? (t = g.rounding) : _(t, 0, 8)) : ((i = g.precision), (t = g.rounding)), !e.isFinite())) c = Ve(e);
    ...
    if (!a[0]) c = v ? "0p+0" : "0";
      ...
      if (
        (o < 0 ? s-- : ((e = new g(e)), (e.d = a), (e.e = s), (e = S(e, d, i, t, 0, r)), (a = e.d), (s = e.e), (f = Te)),
        (o = a[i]),
        (u = r / 2),
        (f = f || a[i + 1] !== void 0),
      ...
      : !e.d && !n.d
        ...
        : !n.d || e.isZero()
          ...
          : !e.d || n.isZero()
            ...
            : n.s < 0
              ? ((this.precision = s), (this.rounding = 1), (i = this.atan(S(e, n, s, 1))), (n = D(this, s, 1)), (this.precision = t), (this.rounding = r), (i = e.s < 0 ? i.minus(n) : i.plus(n)))
...
function En(e) {
  ...
  var n,
    ...
    t,
    r = e.defaults === !0,
    s = ["precision", 1, $, "rounding", 0, 8, "toExpNeg", -H, 0, "toExpPos", 0, H, "maxE", 0, H, "minE", -H, 0, "modulo", 0, 9];
