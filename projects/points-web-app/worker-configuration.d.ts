/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: e406e7ac9b2f28122ed7ab10548c93ec)
...
interface __BaseEnv_Env {
	...
	APP_HOST: "staging.points.freeism.app" | "points.freeism.app" | "localhost";
	APP_ORIGIN: "https://staging.points.freeism.app" | "https://points.freeism.app" | "http://localhost:3000";
	MARKETS_SETTLEMENT_RETRY_RESOURCE: "https://staging.markets.freeism.app/api/settlements/retry" | "https://markets.freeism.app/api/settlements/retry" | "http://localhost:3001/api/settlements/retry";
	OPS_ALERT_FROM: "alerts@freeism.app" | "alerts@example.test";
	OPS_ALERT_TO: "ops@freeism.app" | "ops@example.test";
...
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		MARKETS_SETTLEMENT_RETRY_RESOURCE: "https://staging.markets.freeism.app/api/settlements/retry";
		OPS_ALERT_FROM: "alerts@freeism.app";
		OPS_ALERT_TO: "ops@freeism.app";
		BETTER_AUTH_SECRETS: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		GITHUB_CLIENT_ID: string;
	...
	interface ProductionEnv {
		...
		ASSETS: Fetcher;
		APP_ENV: "production";
		APP_HOST: "points.freeism.app";
		APP_ORIGIN: "https://points.freeism.app";
		MARKETS_SETTLEMENT_RETRY_RESOURCE: "https://markets.freeism.app/api/settlements/retry";
		OPS_ALERT_FROM: "alerts@freeism.app";
		OPS_ALERT_TO: "ops@freeism.app";
		BETTER_AUTH_SECRETS: string;
		GOOGLE_CLIENT_ID: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_HOST" | "APP_ORIGIN" | "MARKETS_SETTLEMENT_RETRY_RESOURCE" | "OPS_ALERT_FROM" | "OPS_ALERT_TO" | "BETTER_AUTH_SECRETS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET" | "INITIAL_ADMIN_GOOGLE_ACCOUNT_ID" | "CSV_EXPORT_CURSOR_SECRET" | "POINTS_OAUTH_PAIRWISE_SECRET" | "ACCOUNTS_KEY_ENCRYPTION_KEY" | "MARKETS_USER_OAUTH_CLIENT_ID" | "MARKETS_USER_OAUTH_CLIENT_SECRET" | "MARKETS_M2M_OAUTH_CLIENT_ID" | "MARKETS_M2M_OAUTH_CLIENT_SECRET" | "MARKETS_SETTLEMENT_OAUTH_CLIENT_ID" | "MARKETS_SETTLEMENT_OAUTH_CLIENT_SECRET" | "OPS_RESOURCE_HASH_SALT" | "TURNSTILE_SITE_KEY" | "TURNSTILE_SECRET_KEY" | "POINTS_OPS_DRILL_TOKEN">> {}
}
