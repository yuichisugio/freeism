  ...
  const rows = [
    {
      ...
      sql: 'CREATE TABLE settlement_capture_receipts (CONSTRAINT "settlement_capture_receipts_plan_hash_check" CHECK (length("settlement_capture_receipts"."plan_hash") = 64))',
    },
    {
      type: "table",
    ...
    },
    {
      ...
      name: "proofs",
      tbl_name: "proofs",
      sql: 'CREATE TABLE proofs (CONSTRAINT "proofs_content_hash_check" CHECK (length("proofs"."content_hash") = 64))',
    },
    {
      type: "table",
      name: "settlement_finalize_receipts",
      tbl_name: "settlement_finalize_receipts",
      sql: 'CREATE TABLE settlement_finalize_receipts (CONSTRAINT "settlement_finalize_receipts_proof_set_hash_check" CHECK (length("settlement_finalize_receipts"."proof_set_hash") = 64))',
    },
    {
      type: "table",
