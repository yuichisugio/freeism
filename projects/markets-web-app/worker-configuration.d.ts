/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 32a415314ebe93b395a36761848bfe2c)
...
interface __BaseEnv_Env {
	...
	APP_ORIGIN: "https://staging.markets.freeism.app" | "https://markets.freeism.app" | "http://localhost:3001";
	OPS_ALERT_FROM: "alerts@freeism.app" | "alerts@example.test";
	OPS_ALERT_TO: "ops@freeism.app" | "ops@example.test";
	POINTS_AUDIENCE: "https://staging.points.freeism.app/api/v1" | "https://points.freeism.app/api/v1" | "http://localhost:3000/api/v1";
	POINTS_ISSUER: "https://staging.points.freeism.app/api/auth" | "https://points.freeism.app/api/auth" | "http://localhost:3000/api/auth";
	...
	AUCTION_ROOMS: DurableObjectNamespace<import("./src/server").AuctionRoom>;
	POINTS_SERVICE: Fetcher /* points-worker-staging */ | Fetcher /* points-worker-production */ | Fetcher /* points-worker */;
	AUCTION_SETTLEMENT: Workflow<Parameters<import("./src/server").AuctionSettlementWorkflow['run']>[0]['payload']>;
}
declare namespace Cloudflare {
	...
	interface StagingEnv {
		...
		POINTS_AUDIENCE: "https://staging.points.freeism.app/api/v1";
		...
		POINTS_SETTLEMENT_CLIENT_SECRET: string;
		AUCTION_ROOMS: DurableObjectNamespace<import("./src/server").AuctionRoom>;
		POINTS_SERVICE: Fetcher /* points-worker-staging */;
		AUCTION_SETTLEMENT: Workflow<Parameters<import("./src/server").AuctionSettlementWorkflow['run']>[0]['payload']>;
	}
	interface ProductionEnv {
		...
		OPS_ALERT_FROM: "alerts@freeism.app";
		OPS_ALERT_TO: "ops@freeism.app";
		POINTS_AUDIENCE: "https://points.freeism.app/api/v1";
		POINTS_ISSUER: "https://points.freeism.app/api/auth";
		BETTER_AUTH_SECRETS: string;
		GOOGLE_CLIENT_ID: string;
		GOOGLE_CLIENT_SECRET: string;
		OPS_RESOURCE_HASH_SALT: string;
		...
		POINTS_SETTLEMENT_CLIENT_SECRET: string;
		AUCTION_ROOMS: DurableObjectNamespace<import("./src/server").AuctionRoom>;
		POINTS_SERVICE: Fetcher /* points-worker-production */;
		AUCTION_SETTLEMENT: Workflow<Parameters<import("./src/server").AuctionSettlementWorkflow['run']>[0]['payload']>;
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "APP_ENV" | "APP_HOST" | "APP_ORIGIN" | "OPS_ALERT_FROM" | "OPS_ALERT_TO" | "POINTS_AUDIENCE" | "POINTS_ISSUER" | "BETTER_AUTH_SECRETS" | "GOOGLE_CLIENT_ID" | "GOOGLE_CLIENT_SECRET" | "OPS_RESOURCE_HASH_SALT" | "POINTS_USER_CLIENT_ID" | "POINTS_USER_CLIENT_SECRET" | "POINTS_M2M_CLIENT_ID" | "POINTS_M2M_CLIENT_SECRET" | "POINTS_SETTLEMENT_CLIENT_ID" | "POINTS_SETTLEMENT_CLIENT_SECRET">> {}
}
