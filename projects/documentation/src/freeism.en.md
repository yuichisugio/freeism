...
- **Examples**
  ...
  3. Google's site/domain verification guides multiple methods including DNS TXT, CNAME, HTML, and so on. ([Google Help](https://support.google.com/webmasters/answer/9008080?hl=en), [Google for Developers](https://developers.google.com/site-verification/v0.1/getting_started))
...
22. Official registry APIs for each ecosystem
    ...
    3. Ruby (RubyGems)
       - `GET https://rubygems.org/api/v0.1/gems/<gem>.json` → the `dependencies` key contains `runtime` / `development`
