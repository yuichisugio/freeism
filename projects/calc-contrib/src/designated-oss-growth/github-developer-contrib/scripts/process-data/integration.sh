...
source "${PROCESS_DIR}/utils/process-data-utils.sh"
...
source "${PROCESS_DIR}/star/star-main.sh"
source "${PROCESS_DIR}/fork/fork-main.sh"
source "${PROCESS_DIR}/watch/watch-main.sh"
source "${PROCESS_DIR}/sponsor/sponsor-main.sh"
source "${PROCESS_DIR}/meta/meta-main.sh"
