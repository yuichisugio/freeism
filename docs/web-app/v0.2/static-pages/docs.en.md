...
This page is the fixed documentation entry point for Freeism Web App v0.2.
...
The public page does not provide a function that directly operates on repository paths. At build time, fixed navigation and summaries are generated from the Markdown files listed above. No authenticated data or runtime server functions are used.
