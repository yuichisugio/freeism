...
Freeism v0.2 is divided into Points, which handles points, and Markets, which handles items and Auctions.
...
Record the request ID displayed on the screen, the time of the operation, and the domain you were using. Do not share OAuth Tokens, Cookies, Client Secrets, or CSV contents.
