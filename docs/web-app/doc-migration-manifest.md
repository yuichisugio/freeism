...
| SRC-026 | `projects/web-app/docs/v0.2/details-ja/auth.md` | [v0.2/authentication.md](./v0.2/authentication.md)、[Accounts v0.1仕様](../../projects/accounts-web-app/docs/specification/v0.1/main.md) | 現行正本 | サービスごとの認証は横断認証仕様、外部アカウントの証明・連携・公開はAccounts仕様を参照 |
...
| SRC-034 | `projects/web-app/docs/v0.2/details-ja/profile-setting.md` | [points v0.2 profile-setting.md](../../projects/points-web-app/docs/v0.2/details-ja/profile-setting.md)、[Accounts v0.1仕様](../../projects/accounts-web-app/docs/specification/v0.1/main.md) | 現行正本 | Points固有のプロフィール・言語設定はPoints仕様、外部アカウント・外部URL・公開設定はAccounts仕様へ集約 |
...
| SRC-038 | `projects/web-app/docs/v0.2/details-ja/prototype-scraping-site-account.md` | [初期メモarchive](../../projects/points-web-app/plan/archive/prototype-scraping-site-account.md)、[Points実装plan](../../projects/points-web-app/plan/v0.2-implementation.md)、[Accounts v0.1仕様](../../projects/accounts-web-app/docs/specification/v0.1/main.md)、[Accounts実装計画](../../projects/accounts-web-app/docs/implementation-plan/v0.1.md) | archive・非正規 / 現行planへ統合 | 外部Webページの所有権証明はAccounts仕様と実装計画、照合結果を利用する未受領FIX処理はPoints仕様と実装計画へ集約 |
