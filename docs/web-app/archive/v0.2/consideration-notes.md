外部アカウントの統合・所有権証明・情報提供に関する要件は[Accounts v0.1仕様](../../../../projects/accounts-web-app/docs/specification/v0.1/main.md)を参照する。この文書はPoints・Marketsの検討記録である。
...
- データ移行を簡単にする
  - インポート
    - `profile-example.csv`
    - 外部アカウントのインポート・エクスポートは[Accounts v0.1仕様](../../../../projects/accounts-web-app/docs/specification/v0.1/main.md)を参照する。
  - ## エクスポート
...
- ページ構成
  ...
  4.  無料主義のECマーケットプレイス
      ...
      - 説明
        ...
        - また、ポイント活用先として使用する
  5.  外部アカウントの統合サービス
      - サービスの責務・登録・連携・公開許可は[Accounts v0.1仕様](../../../../projects/accounts-web-app/docs/specification/v0.1/main.md)を参照する。

- Points・Marketsのサービス選択に関する研究候補
  - 複数の独立サービスから利用先を選ぶ構成は、各サービスの責務と連携契約を分けて検討する。
