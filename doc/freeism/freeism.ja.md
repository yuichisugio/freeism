...
1. **一つの作業を複数の視点（評価軸・価値観）から評価でき、報酬が得られる**
   - 環境保護、OSS の発展、幸福度の高い生活、町の発展など
2. **現在では成り立たないビジネスモデルが実現可能**
   - 報酬は「支払い能力があるか」ではなく、評価軸に貢献しているかで決まるため
   - それにより、現在はクローズドな技術を公開しながら報酬が得られる仕組みを作れる
