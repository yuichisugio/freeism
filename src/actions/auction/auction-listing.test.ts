import type { GetAuctionListingsParams } from "@/actions/auction/cache/cache-auction-listing";
...
const mockCachedGetAuctionListingsAndCount = vi.mocked(
  (await import("@/actions/auction/cache/cache-auction-listing")).cachedGetAuctionListingsAndCount,
);
const mockCachedGetSearchSuggestions = vi.mocked(
  (await import("@/actions/auction/cache/cache-auction-suggestion")).cachedGetSearchSuggestions,
);
