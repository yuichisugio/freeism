      ...
      <main className="container mx-auto min-h-screen px-4 py-12">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="prose prose-blue mx-auto max-w-none space-y-6 text-neutral-700">
            <section>
              <h2 className="text-xl font-semibold text-blue-800">1. 個人情報の収集</h2>
              <p>Freeism-App（以下、「当サービス」といいます。）は、以下の個人情報を収集することがあります：</p>
            ...
            <section>
              <h2 className="text-xl font-semibold text-blue-800">2. 個人情報の利用目的</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold text-blue-800">4. 個人情報の第三者提供</h2>
              <p>当サービスは、以下の場合を除き、収集した個人情報を第三者に提供することはありません：</p>
              <ul className="list-inside list-disc">
                <li>ユーザーの同意がある場合</li>
                <li>法令に基づく場合</li>
            ...
            <section>
              <h2 className="text-xl font-semibold text-blue-800">7. お問い合わせ</h2>
              <p>本プライバシーポリシーに関するお問い合わせは、当サービスの問い合わせフォームまでご連絡ください。</p>
            </section>
          </div>
        </div>
      </main>
