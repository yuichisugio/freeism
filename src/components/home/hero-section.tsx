      ...
      <div className="relative container mx-auto">
        <div className="mx-auto text-center sm:max-w-lg md:max-w-2xl lg:max-w-3xl">
          ...
          <div className="flex flex-col items-center justify-center gap-3 sm:flex-row sm:gap-4">
            <Button variant="outline" size="lg" className="w-40 border-blue-200 bg-white text-blue-700 hover:bg-blue-50 hover:text-blue-700 sm:w-auto sm:min-w-[200px] dark:border-blue-800 dark:bg-gray-950 dark:text-blue-300 dark:hover:bg-blue-950 dark:hover:text-blue-200" asChild>
            ...
            {session ? (
              <Button variant="outline" size="lg" className="w-40 border-blue-200 bg-white text-blue-700 hover:bg-blue-50 hover:text-blue-700 sm:hidden sm:w-auto sm:min-w-[200px] dark:border-blue-800 dark:bg-gray-950 dark:text-blue-300 dark:hover:bg-blue-950 dark:hover:text-blue-200">
