...
export function DescriptionSection() {
  return (
    <section
      className="relative overflow-hidden bg-gradient-to-b from-white via-blue-50 to-white py-16 sm:py-20 lg:py-24"
      id="features"
    >
      {/* 装飾的な背景要素（大きな円形のブラーエフェクト） */}
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-0 left-1/2 h-[600px] w-[600px] -translate-x-1/2 rounded-full bg-blue-100/30 blur-3xl sm:h-[800px] sm:w-[800px] lg:h-[1000px] lg:w-[1000px]" />
      </div>
