    ...
    <footer className="w-full border-t border-blue-100 bg-linear-to-b from-white to-blue-50">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 gap-12 sm:grid-cols-2 md:grid-cols-4">
          <div>
            <h3 className="mb-4 text-lg font-semibold text-blue-900">About</h3>
          ...
          <div>
            <h3 className="mb-4 text-lg font-semibold text-blue-900">Legal</h3>
            <ul className="space-y-3">
              <li>
                <Link
                  href="/terms"
        ...
        <div className="mt-12 border-t border-blue-100 pt-8 text-center">
