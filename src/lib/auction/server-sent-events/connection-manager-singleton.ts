...
if (!instance) {
  console.log(`>>>> Instance NOT FOUND in global scope (value: ${globalScope[CM_INSTANCE_KEY]}). Creating NEW instance.`);
  ...
  console.log(`>>>> Instance FOUND in global scope (value: ${globalScope[CM_INSTANCE_KEY]}). Reusing existing instance.`);
