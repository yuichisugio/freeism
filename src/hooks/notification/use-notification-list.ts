...
export function useNotificationList(): NotificationManagerResult {
  ...
  }, [pathname, syncNotificationsMutate]);
  ...
  return {
    ...
    isLoading: queryIsLoading && currentPage === 1 && notifications.length === 0,
    isLoadingMore: queryIsFetching && currentPage > 1,
    error: queryError
