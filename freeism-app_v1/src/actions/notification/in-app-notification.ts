 ...
 */
export async function sendInAppNotification(notificationParams: NotificationParams): PromiseResult<null> {
  // ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
  ...
  if (notificationParams.notificationId) {
    ...
    return { success: true, message: "通知を更新しました", data: null };
  }
   ...
   * 成功を返す
   */
  return { success: true, message: "通知を作成しました", data: null };
}
