 ...
 */
export async function sendAuctionNotification(params: AuctionNotificationParams): PromiseResult<null> {
   ...
   */
  const { data } = await getAuctionNotificationMessage(params.auctionEventType, params.text);
...
): PromiseResult<{ title: string; body: string; targetType: NotificationTargetType }> {
  // ーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーーー
