 ...
 */
export async function bulkUpdateFixedEvaluations(
  data: FixedEvaluationData[],
  groupId: string,
  userId: string,
): PromiseResult<{ successData: FixedEvaluationData[]; failedData: FixedEvaluationData[] } | null> {
